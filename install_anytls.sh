...
[Service]
ExecStart=$BINARY_DIR/$BINARY_NAME -l 10.0.0.4:80 -p $PASSWORD
Restart=always
User=root
Group=root
...
EOF
    ...
    echo -e "\033[32m√ 监听端口: 10.0.0.4:80\033[0m"
    ...
    echo -e "\033[30;43m\033[1m anytls://$PASSWORD@$SERVER_IP:80/?insecure=1 \033[0m"
