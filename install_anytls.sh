...
get_ip() {
    ...
    [ -z "$ip" ] && ip=$(ifconfig 2>/dev/null | grep -oP 'inet \K[\d.]+' | grep -v '10.0.0.4' | head -n1)
...
[Service]
ExecStart=$BINARY_DIR/$BINARY_NAME -l 10.0.0.4:2323 -p $PASSWORD
Restart=always
User=root
Group=root
...
EOF
    ...
    echo -e "\033[32m√ 监听端口: 10.0.0.4:2323\033[0m"
    ...
    echo -e "\033[30;43m\033[1m anytls://$PASSWORD@$SERVER_IP:2323/?insecure=1 \033[0m"
